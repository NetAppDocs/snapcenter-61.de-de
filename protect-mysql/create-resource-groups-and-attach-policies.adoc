...
NOTE: Die benutzerdefinierten Schlüssel-Wert-Paare werden für MySQL Linux-Plug-in-Systeme unterstützt, nicht jedoch für MySQL-Datenbanken, die als zentrales Windows-Plug-in registriert sind.
