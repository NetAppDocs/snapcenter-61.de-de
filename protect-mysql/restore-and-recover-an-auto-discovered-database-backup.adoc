...
* Die automatische Wiederherstellung zu einem bestimmten Zeitpunkt und auf die Minute genau wird nicht unterstützt.
...
. Wählen Sie auf der Seite „Wiederherstellungsbereich“ *Vollständige Ressource* aus, um die konfigurierten Datenvolumes der MySQL-Datenbank wiederherzustellen.
