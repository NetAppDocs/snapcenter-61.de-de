...
Um das CA-Zertifikat mit dem SnapCenter Plug-in für VMware vSphere zu konfigurieren, siehe  https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["SSL-Zertifikat erstellen oder importieren"^].
