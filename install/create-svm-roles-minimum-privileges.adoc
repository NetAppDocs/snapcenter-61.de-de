...
summary: Sie sollten SVM-Rollen erstellen, wenn Sie SVMs in ONTAP zur Verwendung mit SanpCenter konfigurieren und die Rolle „vsadmin“ nicht verwenden möchten. 
---
