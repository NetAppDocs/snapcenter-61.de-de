...
summary: Sie sollten SVM-Rollen erstellen, wenn Sie SVMs in ASA r2-Systemen für die Verwendung mit SanpCenter konfigurieren und die Rolle „vsadmin“ nicht verwenden möchten. 
---
