...
summary: Sie sollten ONTAP Clusterrollen für ASA R2-Systeme erstellen, damit Sie die ONTAP Administratorrolle nicht verwenden müssen, um Vorgänge in SnapCenter auszuführen. 
---
